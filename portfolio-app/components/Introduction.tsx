...
function Introduction() {
  return (
    <div>
      <h1
        className="text-white font-extralight text-8xl text-center text-opacity-80 pt-12 pb-2"
      ...
      <div className="w-full">
        <p className="text-white w-1/3 mx-auto text-center text-opacity-80 pt-6 pb-2">
